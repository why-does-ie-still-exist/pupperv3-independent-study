...
#. **Important:** *To set a motor controller to a certain ID, click (short press) press to put the motor controller into id-setting mode,
   then click N more times in quick succession, where N is the* **zero-indexed** *desired ID.*
...
.. list-table::
    ...
    * - ID
      - Presses
    * - 0
      - One short press to program followed by one press
    * - 1
      - One short press to program followed by two presses
    * - 2
      - One short press to program followed by three Presses
    * - ...
      - ...
